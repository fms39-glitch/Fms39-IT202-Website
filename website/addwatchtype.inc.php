...
if (isset($_SESSION['login'])) {
    $watches_type_id = filter_input(INPUT_POST, 'watches_type_id', FILTER_VALIDATE_INT);  // for phase 4
    if ((trim($watches_type_id) == '') or (!is_int($watches_type_id))) {
        ...
        $watches_type_code = htmlspecialchars($_POST['watches_type_code']);
        $watches_type_name = htmlspecialchars($_POST['watches_type_name']);
